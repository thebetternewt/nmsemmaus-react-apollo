...
import sponsorship from '../images/sponsorship.jpeg';

const Sponsorship = () => {
  return (
    <div>
      <Hero backgroundImage={sponsorship} size="sm">
        <h1>Sponsorship</h1>
      </Hero>
      <main style={{ padding: '2rem' }}>
        ...
        >
          <Grid item md={10} lg={8}>
            <h2>Emmaus Sponsorship</h2>
            <p>
              Good sponsorship is vital to the integrity of Emmaus. Many
              communities take sponsorship for granted; they assume that
              everyone knows the how and why of sponsorship. Yet sponsorship is
              the most important job in Emmaus. It is more than just “signing up
              people”. The quality of sponsorship influences the pilgrim, the
              health of the Emmaus Movement, and the church affected by the
              movement.
            </p>
            <p>
              First, good sponsorship is your first act of agape before a Walk
              ever begins; the experience of the Walk for a pilgrim really
              starts with how we handle sponsorship.
            </p>
            <p>
              Second, good sponsorship undergirds the whole weekend with
              sacrificial love on behalf of each pilgrim. Sponsors use
              discernment in recruiting pilgrims, embody the personal commitment
              of the community to each pilgrim, and provide personal acts of
              agape during the three days for the pilgrims. These acts of agape
              include prayer, agape letters, and presence at Send off,
              Candlelight and Closing, and follow-up.
            </p>
            <p>
              Third, good sponsorship is the foundation for a healthy, effective
              Emmaus movement that is fulfilling its true purpose - the
              development of Christian leaders and the renewal of the church in
              ministry. The strength of any Emmaus community is a direct result
              of its recruiting practices. If the community is committed to
              recruiting strong church leaders for the purpose of strengthening
              the local church, then the community will be a strong, vital force
              in the renewal movement. If, on the other hand, the Walk to Emmaus
              is looked upon as a hospital where every human ill can be cured,
          ...
          <Grid item md={10} lg={8}>
            ...
            <p>
              ...
              to fill up the weekend, to fix people's problems, or to reproduce
              one's own religious experience in others. Rather, the aim of the
              sponsor is to bring spiritual revitalization to Christians who, in
              turn, will bring new life and vision to the work of the church in
              the congregation, home, workplace, and community. The aim of
              sponsorship is to build up the Body of Christ.
            </p>
          </Grid>
          ...
          <Grid item md={10} lg={8}>
            ...
            <p>
              ...
              grow and move forward in their journey of faith.
            </p>
            <p>
              Second, the person should have a Christian passion. The pilgrim
              knows God can make and has made a difference in their life.
            </p>
            <p>
              Third, the person isn’t so consumed by life’s circumstances that
              they are unable to give full attention to the message and
              experience of Emmaus.
            </p>
          ...
          <Grid item md={10} lg={8}>
            ...
            <p>
              ...
              days. However, keep in mind <strong>there are no secrets!</strong>{' '}
              Saying to a pilgrim that you can’t tell them anything about the
              Walk potentially creates unnecessary suspicion and anxiety. And
              for clergy and staff leadership, this posture builds a wall of
          ...
          <Grid item md={10} lg={8}>
            ...
            <p>
              ...
              these forms can be found by clicking here.
            </p>
            <p>
          ...
          <Grid item md={10} lg={8}>
            ...
            <ul>
              <li>
                DAY FOUR: The Pilgrim's Continued Journey by Robert Wood & Marie
                Livingston Roy
              </li>
              <li>
                THE UPPER ROOM HANDBOOK ON EMMAUS, 2nd Edition by Stephen Bryant
                & Richard Gilmore{' '}
              </li>
            </ul>
            <p>
            ...
            <ul>
              <li>
                SPONSORSHIP by Richard & Janine Gilmore – The Emmaus Library
                series
              </li>
              <li>
